...
class Esteganew:
    ...
    def __init__(self, file_storage,nombre_imagen:str, mensaje = None, nuevo_nombre = None, ):
        """
        ...
        arguprint(uploaded_file.name)mento se exige un nombre para el archivo de salida de tipo 'str'.
        """
    ...
    def codificar(self):
        ...
        if (self.mensaje == None):
            ...
            self.cambiar_pix()
            return self.file_storage.save(self.copia_img, self.nuevo_nombre+".png")
